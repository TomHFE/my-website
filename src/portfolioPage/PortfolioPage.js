    ...
    <div className="mov-container">
      ...
      <motion.div style={{ marginTop: "7rem" }}>
        ...
        >
          ...
          <div className="mov-text">
            <p>
              React based application for Films and TV shows. This App enables
              the user to search for movies by their name. This then fetches to
              an api which looks for information related to the film such as
              plot, runtime and actors/directors involved with the film.
            </p>
            <h3>Features</h3>
            <ul>
              <li>Input search to an API through an async function</li>
